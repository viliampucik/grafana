...
export class UsersActionBar extends PureComponent<Props> {
  render() {
    ...
    const canInviteToOrg = contextSrv.hasAccess(AccessControlAction.OrgUsersInvite, canInvite);
    ...
    return (
      <div className="page-action-bar">
        ...
        {canInviteToOrg && <LinkButton href="org/users/invite">Invite</LinkButton>}
        {externalUserMngLinkUrl && (
